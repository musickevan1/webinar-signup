      ...
      <div className="mx-auto max-w-4xl">
        <div className="flex flex-col items-center gap-8 sm:flex-row sm:justify-center sm:gap-16">
          ...
          <div className="text-center">
            ...
            <ul className="flex justify-center gap-4 text-sm text-text-secondary">
              <li>
                <a
              ...
              <li>
                <a
                  href="https://facebook.com/timlambertrealty"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 transition-colors hover:text-accent"
                  title="Facebook"
              ...
              <li>
                <a
                  href="https://tiktok.com/@timlambertrealty"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 transition-colors hover:text-accent"
                  title="TikTok"
              ...
              <li>
                <a
                  href="https://youtube.com/@timlambertrealty"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 transition-colors hover:text-accent"
                  title="YouTube"
            ...
            <p className="mt-3 text-sm text-text-secondary">@timlambertrealty</p>
          </div>
        </div>
